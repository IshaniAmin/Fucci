...
console.log('Todays Date ' + newDate)
  ...
  fetch(`http://api.football-api.com/2.0/matches?match_date=03.05.2017&to_date=03.05.2017&Authorization=565ec012251f932ea4000001fa542ae9d994470e73fdb314a8a56d76`)
    .then(res => res.json())
    .then(matches => {
