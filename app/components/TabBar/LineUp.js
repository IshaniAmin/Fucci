...
import Away from './TeamLineUp.js'
...
export default class LineUp extends React.Component {
 ...
 const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
  ...
  this.handleTeamLineUp = this.handleTeamLineUp.bind(this);
...
render() {
    ...
    return (
     ...
     <View style={styles.mainContainer}>
        <Text style={styles.teamName}>{this.state.teamName1}</Text>
        <ListView
        ...
        />
        <Text style={styles.teamName}>{this.state.teamName2}</Text>
        <ListView
          style={styles.matches}
          dataSource={this.state.teamInfo2}
          renderRow={(team2) =>
          <View>
            <Text>{team2.name} - {team2.position} </Text>
          </View>
          }
        />
    </View>
